...
# Import the reload_app_with_env fixture
import sys
sys.path.append('.')

from tests.test_memory_api_integration import reload_app_with_env

def test_fixture_module_reloading():
    ...
    print(f"Config enable_auth: {auth_module1._default_config.enable_auth}")
    ...
    print(f"Config enable_auth: {auth_module2._default_config.enable_auth}")
