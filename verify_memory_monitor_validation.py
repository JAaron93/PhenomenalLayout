...
def test_validation():
    ...
    try:
        ...
        print("  ❌ Should have failed with start_memory_monitoring alert_threshold_mb=-1.0")
        return False
    except ValueError as e:
        print(f"  ✓ Correctly rejected start_memory_monitoring alert_threshold_mb=-1.0: {e}")
    except Exception as e:
        print(f"  ❌ Wrong exception type: {e}")
        return False
