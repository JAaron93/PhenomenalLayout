...
def test_endpoint_debugging():
    ...
    with patch.dict("os.environ", test_env):
        ...
        assert not api.auth.is_auth_enabled(), "Authentication should be disabled"
        ...
        assert json_response["success"] is True, "Response should indicate success"
        assert "data" in json_response, "Response should contain data field"
        data = json_response["data"]
        assert "current_memory_mb" in data, "Response should contain current_memory_mb"
